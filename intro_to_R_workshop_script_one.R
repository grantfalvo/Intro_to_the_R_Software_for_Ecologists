...
### Basic arithmetic, using objects and using functions
### adapted from https://cengel.github.io/R-intro/gettingstarted.html
### clear your environment with this rm(list = ls())
...
### adapted from https://rstudio-education.github.io/hopr/basics.html 
